...
(
	...
	///////////JD BNL added
	output [13:0] deframed_aligned [15:0][31:0], // [link][sample]
	output [1:0] deframed_state [7:0],
	///////////
    ...
    generate
        ...
        begin
            ...
            frame_builder_single_modified #(.NUM(gi)) fbs
            (
				...
				//////JD BNL added:
				.deframed_aligned_out (deframed_aligned [gi*2+1 : gi*2]),
				.rq_state_out		  (deframed_state [gi]),	
				//////				
