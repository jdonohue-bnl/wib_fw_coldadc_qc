module frame_builder_single_modified #
(
...
(
	...
	///////JD BNL added
	output [13:0] deframed_aligned_out [NLINKS-1:0][31:0], // [link][sample] //output reg [13:0]
	output [1:0] rq_state_out,	
	///////
...
// samples [15:0] = ADC0, samples [31:16] = ADC1
	...
	////////////JD BNL added:
	assign rq_state_out = rq_state;
	assign deframed_aligned_out = deframed_aligned;
	////////////
